...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        wgBtnStatusDaoConfig = daoConfigMap.get(WgBtnStatusDao.class).clone();
        wgBtnStatusDaoConfig.initIdentityScope(type);
        ...
        wgBtnStatusDao = new WgBtnStatusDao(wgBtnStatusDaoConfig, this);
        ...
        registerDao(WgBtnStatus.class, wgBtnStatusDao);
    ...
    public void clear() {
        ...
        wgBtnStatusDaoConfig.clearIdentityScope();
    ...
    public WgBtnStatusDao getWgBtnStatusDao() {
        return wgBtnStatusDao;
    }
